/**
 * Alloc Strike — Selvr-style: reuse one Float64Array output buffer every frame (no heap churn).
 */
(() => {
  const N = 65536;
  ...
  function frame(now) {
    ...
    ctx.fillText(`${N.toLocaleString()} samples · reused Float64Array · Selvr-style`, 8, 20);
